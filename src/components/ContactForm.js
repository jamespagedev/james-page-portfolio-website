...
const InputContact = styled.input`
  ...
  border-bottom-color: ${props => props.disabled === "disabled" ? 'gray' : 'white'};
  border-right-color: ${props => props.disabled === "disabled" ? 'gray' : 'white'};
    ...
    <DivContactContainer>
      <FormContact>
        <DivInput>
          ...
          <InputContact type="text" name="name" id="name" disabled="disabled" value={props.contactData.name} onChange={props.handleChange} required />
        </DivInput>
        <DivInput>
          <LabelContact htmlFor="email" email="true">Email:&nbsp;</LabelContact>
          <InputContact type="email" name="email" id="email" disabled="disabled" value={props.contactData.email} onChange={props.handleChange} required />
        </DivInput>
        <DivInput>
          <LabelContact htmlFor="subject" subject="true">Subject:&nbsp;</LabelContact>
          <InputContact type="text" name="subject" id="subject" disabled="disabled" autoComplete="off" value={props.contactData.subject} onChange={props.handleChange} required />
        </DivInput>
        <DivTextArea>
          <LabelContact htmlFor="message">Message:</LabelContact>
          <Textarea name="message" id="message" rows="6" disabled="disabled" value={props.contactData.message} onChange={props.handleChange} required />
        </DivTextArea>
        {/* <DivButtons>
